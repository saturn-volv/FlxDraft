...
HX_LOCAL_STACK_FRAME(_hx_pos_4de4efe70e9aaf52_531_requestUrl,"sys.Http","requestUrl",0x3992c905,"sys.Http.requestUrl","C:\\HaxeToolkit\\haxe\\std/sys/Http.hx",531,0x92a61a9b)
HX_LOCAL_STACK_FRAME(_hx_pos_4de4efe70e9aaf52_534_requestUrl,"sys.Http","requestUrl",0x3992c905,"sys.Http.requestUrl","C:\\HaxeToolkit\\haxe\\std/sys/Http.hx",534,0x92a61a9b)
HX_LOCAL_STACK_FRAME(_hx_pos_4de4efe70e9aaf52_527_requestUrl,"sys.Http","requestUrl",0x3992c905,"sys.Http.requestUrl","C:\\HaxeToolkit\\haxe\\std/sys/Http.hx",527,0x92a61a9b)
...
::String Http_obj::requestUrl(::String url){
            		...
            		void _hx_run(::String d){
            			HX_GC_STACKFRAME(&_hx_pos_4de4efe70e9aaf52_531_requestUrl)
HXLINE( 531)			r[0] = d;
            		}
            		HX_END_LOCAL_FUNC1((void))
            		...
            		void _hx_run(::String e){
            			HX_GC_STACKFRAME(&_hx_pos_4de4efe70e9aaf52_534_requestUrl)
HXLINE( 534)			HX_STACK_DO_THROW(e);
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_4de4efe70e9aaf52_527_requestUrl)
HXLINE( 528)		 ::sys::Http h =  ::sys::Http_obj::__alloc( HX_CTX ,url);
HXLINE( 529)		::Array< ::String > r = ::Array_obj< ::String >::__new(1)->init(0,null());
HXLINE( 530)		h->onData =  ::Dynamic(new _hx_Closure_0(r));
HXLINE( 533)		h->onError =  ::Dynamic(new _hx_Closure_1());
HXLINE( 536)		h->request(false);
HXLINE( 537)		return r->__get(0);
            	}
