...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("MTG_DRAFT", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("MTG_DRAFT", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "MTG_DRAFT";
		app.meta["name"] = "MTG_DRAFT";
